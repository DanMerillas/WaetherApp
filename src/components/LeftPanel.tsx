...
export default function LeftPanel(props: { currentWeather: any; location: string; enableLocation: any; }) {
    ...
    return (
        <>
            {props.currentWeather ? <article className="App-left">
                <div className="App-weather-location-control" onClick={()=>props.enableLocation()} title="Obtener ubicación actual">
